              ...
              <div class="container-fluid mt-auto">
                <div id="head">
                  ...
                  <div class="attendTable">
                      ...
                      <col style="width:30px; height:15px">
                      <col style="width:10px; height:15px">
                      <col style="width:30px; height:15px">
                      <col style="width:30px; height:15px">
                      <col style="width:10px; height:15px">
                        <thead>
                        ...
                        <tbody>
                          <?php
                            ...
                            while(date('M',strtotime($day)) == date('M',strtotime('today')))
                            {
